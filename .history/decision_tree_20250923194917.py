...
# Input gejala (contoh C–M)
C = int(input("Apakah pasien mengalami C? (1=Ya,0=Tidak): "))
D = int(input("Apakah pasien mengalami D? "))
E = int(input("Apakah pasien mengalami E? "))
F = int(input("Apakah pasien mengalami F? "))
G = int(input("Apakah pasien mengalami G? "))
H = int(input("Apakah pasien mengalami H? "))
I = int(input("Apakah pasien mengalami I? "))
J = int(input("Apakah pasien mengalami J? "))
K = int(input("Apakah pasien mengalami K? "))
L = int(input("Apakah pasien mengalami L? "))
M = int(input("Apakah pasien mengalami M? "))

# Susun inputan dalam array sesuai urutan kolom
input_data = [[A,B,C,D,E,F,G,H,I,J,K,L,M]]

prediksi = decision_tree.predict(input_data)
print("Hasil prediksi pasien adalah: ", prediksi[0])
